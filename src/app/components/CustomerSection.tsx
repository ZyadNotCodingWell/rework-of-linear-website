...
export default function CustomerSection() {
	...
	<div id="Customers-Section" className=" max-w-96 md:max-w-6xl flex flex-col lg:min-w-96 flex-none md:px-20 self-center mx-auto py-4">
		...
		<div className="relative mt-8 py-4 hidden md:flex md:flex-col w-full text-2xl font-semibold gap-4 px-4" onMouseEnter={() => setBlurredDiv(true)} onMouseLeave={() => setBlurredDiv(false)}>	
			...
			<div className={blurredDiv ? "absolute flex inset-0 w-full items-center justify-center bg-black/55 backdrop-blur-xl z-40 transition duration-300" : "hidden"} >
					<Link href="#">
						<div className="text-xl lg:text-3xl bg-neutral-900 px-4 py-2 rounded-xl lg:rounded-2xl border border-white/30 font-normal min-w-2xl self-center mx-auto"> Meet our customers</div>
					</Link>
			</div>
		</div>
		...
		<div className="md:hidden flex flex-1 my-8 [mask-image:linear-gradient(to_right,transparent,black_30%,black_70%,transparent)]">
			...
			{/* End of phone version of logo autoscroller */}
		</div>
